...
NOW :=$(shell date -u +%Y-%m-%dT%H.%M.%SZ)# ISO time in UTC
DATE:=$(shell date -u +%Y-%m-%d)# ISO date in UTC

# We are using the SubRip (SRT) format:
sub $(MOVIE_NAME).srt:
	@printf "# This subtitle file was (partially) auto-generated by https://github.com/cmarqu/Cycling-Videos\n"
	@printf "# Source(s) for the video: http://cyclingrlv.com/\n"
	@printf "# Generated at $(NOW)\n"
	@printf "\n"
